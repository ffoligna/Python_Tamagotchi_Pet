...
for x in range(n):
	...
	mes = mes + 1
	print(f"Monto del mes {mes} es {montoFinal:.2f}")
...
print(f"La ganancia es: ${ganancia:.2f}")
print(f"El monto final en {mes} meses es: ${montoFinal:.2f}")
print(f"El interés acumulado en {n} meses es: {interesAcumulado:.2f}%.")
